...
public class MapaColegio2 {
	...
	/*
	 * ==================== Ejercicio 1 Mapas ==================== Creamos 7 alumnos
	 * 
	 * Vamos a separar a los alumnos por aulas,
	 * 
	 * aula1 -> 2 alumnos aula2 -> 1 alumnos aula3 -> 4 alumnos
	 * 
	 * - Indicar cuantas aulas tiene el colegio - Mostrar por cada aula los datos de
	 * los alumnos - Mostrar por cada aula cuantos alumnos hay - Solicitar el nombre
	 * de 1 aula y mostrar todos los alumnos del aula si el aula existe - Indicar
	 * cual es el aula que tiene el alumno con la nota media más alta
	 * 
	 * 
	 * ==================== Ejercicio 2 Mapas ==================== Crear clase
	 * Colegio con: nombre, direccion, Map<"String",List<Alumno>> aulas
	 * 
	 * Crear 3 colegios -> Meterlos en una lista y: + recorrer la lista de colegios
	 * para mostrar los datos de cada colegio, el nombre de cada aula del colegio y
	 * por cada aula, el nombre, el apellido y la nota media de sus alumnos
	 * 
	 * + Indicar cual es el colegio que tiene la nota media de alumnos mayor.
	 * 
	 * 
	 * ==================== Ejercicio 3 Mapas ==================== Ejercicio:
	 * Biblioteca por autores
	 * 
	 * Clase Autor -> nombre, nacionalidad Libro -> titulo, isbn, anio
	 * 
	 * Crear una biblioteca donde: La clave del mapa sea un objeto Autor. El valor
	 * sea una lista de libros (List<Libro>) escritos por ese autor.
	 * 
	 * Crear los ojetos correspondientes para que haya 9 libros y 4 autores
	 * 
	 * + mostrar las nacionalidades de los autores + mostrar el título de todos los
	 * libros publicados después del 2010 + mostrar por cada autor que tenga más de
	 * dos libros su nombre y el nombre de todos los libros que tiene publicados +
	 ...
	 * meterlo en la biblioteca, - si el autor sí está ya, agregar el libro a su
	 * listado
	 * 
	...
	public static void main(String[] args) {
		...
		// colegio2.getAulas().get("aula1").add(alumnoN);//Añadimos alumnos a un aula
		// que ya existe
	...
	private static void mostrarDatosColegios(List<Colegio> colegios) {
		 ...
		 * por cada aula, el nombre, el apellido y la nota media de sus alumnos
		 */
		List<Double> almacen = new ArrayList<>();
		...
		for (Colegio colegio : colegios) {
			...
			for (String nombreAula : nombresAulas) {
				...
				System.out.println("La suma total del aula es de " + suma);

			}
			media = suma / cont;
			System.out.println("La media de las notas media de este aula  es de " + media);
			System.out.println("---------------------------------------");
			almacen.add(media);

			System.out.println("La nota media mas alta de los colegios es de: ");
			System.out.println(Collections.max(almacen));
